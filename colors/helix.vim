...
augroup helix
    autocmd!
    autocmd ColorScheme * if expand("<amatch>") == "helix" | for link in links | execute 'hi link' link[0] link[1] | endfor | else | for link in links | execute 'hi link' link[0] 'NONE' | endfor | endif
augroup END
