...
let g:colors_name = "helix-dark"

" User Options
if !exists("g:helix_italic")
    let g:helix_italic = 0
endif
...
"Defining UI colors
let s:black = {"cterm":"0", "gui": "#000000"}           "242430 Background color 330066 - 262626
...
augroup helix-dark
    autocmd!
    autocmd ColorScheme * if expand("<amatch>") == "helix-dark" | for link in links | execute 'hi link' link[0] link[1] | endfor | else | for link in links | execute 'hi link' link[0] 'NONE' | endfor | endif
augroup END
