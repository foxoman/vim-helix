...
if ($TERM =~ '256' || &t_Co >= 256) || has('gui_running')
  ...
  hi LineNr           ctermbg=251  ctermfg=234  guibg=#ffffff guifg=#E4E4E4 cterm=NONE           gui=NONE
  ...
  hi ColorColumn      ctermbg=254  ctermfg=NONE guibg=#NONE guifg=NONE    cterm=NONE           gui=NONE    "" 80 Line
